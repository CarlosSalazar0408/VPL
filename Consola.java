...
class Consola {
    ...
    public  byte leerByte( ){
        ...
        do{
            try{
                numero = new Byte(this.leerCadena( ));
                hayError=false;
            }//fin try
            catch(Exception e){
                hayError=true;
    ...
    public  short leerShort(){
        ...
        do{
            try{
                numero = new Short(this.leerCadena( ));
                hayError=false;
            }//fin try
            catch(Exception e){
                hayError=true;
    ...
    public  int leerEntero(){
        ...
        do{
            try{
                numero = new Integer(this.leerCadena( ));
                hayError=false;
            }//fin try
            catch(Exception e){
                hayError=true;
    ...
    public  long leerLong( ){
        ...
        do{
            try{
                numero = new Long(this.leerCadena( ));
                hayError=false;
            }//fin try
            catch(Exception e){
                hayError=true;
    ...
    public  float leerFloat(){
        ...
        do{
            try{
                numero = new Float(this.leerCadena( ));
                hayError=false;
            }//fin try
            catch(Exception e){
                hayError=true;
    ...
    public  double leerDouble( ){
        ...
        do{
            try{
                numero = new Double(this.leerCadena( ));
                hayError=false;
            }//fin try
            catch(Exception e){
                hayError=true;
    ...
    /**
     * Lee un sÃ³lo caracter char. Cualquier caracter UNICODE (0 -65536) Omite las teclas:
     * <ul>
     * <li>Tecla ENTER: ASCII/UNICODE 10 CR (Carriage Return) = 10 y ASCII/UNICODE 13 LF (Line Feed). Ver <a href="https://danielmiessler.com/study/crlf/#gs.oVKPY7s">https://danielmiessler.com/study/crlf/#gs.oVKPY7s</a></li>
     * <li>Tecla SPACE (barra espaciadora): ASCII/UNICODE 32</li>
     * <li>Tecla TAB (tabulador): ASCII/UNICODE 9</li>
    ...
    /**
     * Lee un valor lÃ³gico: true | false
     * @return un boolean
     */
     ...
     * @param  aviso   Un aviso que indique al usuario el significado del valor a ingresar.
     * @return un String que indica la opciÃ³n seleccionada - 1 (de 0 a length)
     */
